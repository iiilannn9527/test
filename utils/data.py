...
class iDomainNet(iData):
    ...
    def download_data(self):
        ...
        train_data_config = yaml.load(open('utils/domainnet_trainb.yaml', 'r'), Loader=yaml.Loader)
        test_data_config = yaml.load(open('utils/domainnet_testb.yaml', 'r'), Loader=yaml.Loader)
